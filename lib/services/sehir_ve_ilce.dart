...
class SehirveIlce {
  List plakaliSehirListesi = List.generate(81, (index) {
    List sehirlerListesi = [
      "ADANA",
      "ADIYAMAN",
      "AFYONKARAHİSAR",
      "AĞRI",
    ...
    return Sehir(sehirlerListesi[index].toString(), "${index + 1}");
  });
  ...
  List<Ilce> ilceListesiniOlustur(String ilcesiGetirilecekIlidsi) {
    List<Ilce> olusturulanIlceListesi = [];
    for (Map<String, dynamic> deger in ilceler) {
      if (deger["il_id"] == ilcesiGetirilecekIlidsi) {
        olusturulanIlceListesi.add(Ilce(ilceAdi: deger["name"]));
      }
    }

    return olusturulanIlceListesi;
  }
}
...
class Sehir {
  String sehirAdi;
  String sehirPlakaKodu;
  Sehir(this.sehirAdi, this.sehirPlakaKodu);
}
